<template>
    <div class="order-submission">
        ...
        <div class="wrapper">
            ...
            <div class="item acea-row row-between-wrapper" v-if="deduction === false && enableIntegral === true">
                <div>积分抵扣</div>
                <div class="discount">
                    <div class="select-btn">
                        <div class="checkbox-wrapper">
                            <label class="well-check">
                                ...
                                <span class="integral">
                  当前积分
                  <span class="num font-color-red" v-if="userInfo.integral > enableIntegralNum">
...
<style scoped>
    ...
    .order-submission .allAddress .nav .item.on2:before {
        ...
        border-style: none solid solid;
        border-color: transparent transparent #d5e6e6;
