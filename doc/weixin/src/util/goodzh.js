var cityData=[{"id":"酒店用品","name":"酒店用品","shortName":"酒店用品","parentId":"100000","level":"1"},
{"id":"厨房用品","name":"厨房用品","shortName":"厨房用品","parentId":"酒店用品","level":"2"},
{"id":"玻璃制品","name":"玻璃制品","shortName":"玻璃制品","parentId":"酒店用品","level":"2"},
{"id":"陶瓷产品","name":"陶瓷产品","shortName":"陶瓷产品","parentId":"酒店用品","level":"2"},

{"id":"文体用品","name":"文体用品","shortName":"文体用品","parentId":"100000","level":"1"},
{"id":"体育用品","name":"体育用品","shortName":"体育用品","parentId":"文体用品","level":"2"},
{"id":"健身器材","name":"健身器材","shortName":"健身器材","parentId":"文体用品","level":"2"},
{"id":"办公用品","name":"办公用品","shortName":"办公用品","parentId":"文体用品","level":"2"},
{"id":"文化用品","name":"文化用品","shortName":"文化用品","parentId":"文体用品","level":"2"},

{"id":"日用百货","name":"日用百货","shortName":"日用百货","parentId":"100000","level":"1"},
{"id":"饰品","name":"饰品","shortName":"饰品","parentId":"日用百货","level":"2"},
{"id":"玩具","name":"玩具","shortName":"玩具","parentId":"日用百货","level":"2"},
{"id":"工艺礼品","name":"工艺礼品","shortName":"工艺礼品","parentId":"日用百货","level":"2"},
{"id":"皮具箱包","name":"皮具箱包","shortName":"皮具箱包","parentId":"日用百货","level":"2"},
{"id":"时钟摆件","name":"时钟摆件","shortName":"时钟摆件","parentId":"日用百货","level":"2"},
{"id":"电子数码","name":"电子数码","shortName":"电子数码","parentId":"日用百货","level":"2"},

{"id":"茶叶茶具","name":"茶叶茶具","shortName":"茶叶茶具","parentId":"100000","level":"1"},
{"id":"茶叶","name":"茶叶","shortName":"茶叶","parentId":"茶叶茶具","level":"2"},
{"id":"茶具","name":"茶具","shortName":"茶具","parentId":"茶叶茶具","level":"2"},
{"id":"包装产品","name":"包装产品","shortName":"包装产品","parentId":"茶叶茶具","level":"2"},

{"id":"服饰家纺","name":"服饰家纺","shortName":"服饰家纺","parentId":"100000","level":"1"},
{"id":"服装鞋帽","name":"服装鞋帽","shortName":"服装鞋帽","parentId":"服饰家纺","level":"2"},
{"id":"床上用品","name":"床上用品","shortName":"床上用品","parentId":"服饰家纺","level":"2"},
{"id":"窗帘布艺","name":"窗帘布艺","shortName":"窗帘布艺","parentId":"服饰家纺","level":"2"}
];
//借用上展的json转换器
;(function(){
    var data = [],data2 = [];
...
/**
        ...
        $('.goodAddZh').mPicker({
            ...
            idDefault:true,
            splitStr:'-',
            header:'<div class="mPicker-header">请选择商品</div>',
            confirm:function(){
                //更新json
                //this.container.data('mPicker').updateData(level3);
                //console.info($('.select-value').data('value1')+'-'+$('.select-value').data('value2'));
				//alert($('.goodAddZh').data('value1')+'-'+$('.goodAddZh').data('value2'));
				var goods =$("#userFavoriteZh").val();
				var appendValue =$('.goodAddZh').data('value1')+'-'+$('.goodAddZh').data('value2');
