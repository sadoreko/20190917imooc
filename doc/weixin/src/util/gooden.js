var cityData=[{"id":"HotelProduct","name":"Hotel Product","shortName":"Hotel Product","parentId":"100000","level":"1"},
{"id":"KitchenProducts","name":"Kitchen Products","shortName":"Kitchen Products","parentId":"HotelProduct","level":"2"},
{"id":"GlassProducts","name":"Glass Products","shortName":"Glass Products","parentId":"HotelProduct","level":"2"},
{"id":"CeramicProducts","name":"Ceramic","shortName":"Ceramic Products","parentId":"HotelProduct","level":"2"},

{"id":"StationerySports","name":"Stationery Sports","shortName":"Stationery Sports","parentId":"100000","level":"1"},
{"id":"SportsGoods","name":"Sports Goods","shortName":"Sports Goods","parentId":"StationerySports","level":"2"},
{"id":"FitnessEquipment","name":"Fitness Equipment","shortName":"Fitness Equipment","parentId":"StationerySports","level":"2"},
{"id":"OfficeSupplies","name":"Office Supplies","shortName":"Office Supplies","parentId":"StationerySports","level":"2"},
{"id":"CulturalGoods","name":"Cultural Goods","shortName":"Cultural Goods","parentId":"StationerySports","level":"2"},

{"id":"GeneralMerchandise","name":"General Merchandise","shortName":"General Merchandise","parentId":"100000","level":"1"},
{"id":"Accessories","name":"Accessories","shortName":"Accessories","parentId":"GeneralMerchandise","level":"2"},
{"id":"Toy","name":"Toy","shortName":"Toy","parentId":"GeneralMerchandise","level":"2"},
{"id":"CraftGift","name":"Craft Gift","shortName":"Craft Gift","parentId":"GeneralMerchandise","level":"2"},
{"id":"LeatherProducts","name":"Leather Bags Suitcases","shortName":"Leather Bags Suitcases","parentId":"GeneralMerchandise","level":"2"},
{"id":"ClockOrnaments","name":"Clock Ornaments","shortName":"Clock Ornaments","parentId":"GeneralMerchandise","level":"2"},
{"id":"DigitalProducts","name":"Digital Products","shortName":"Digital Products","parentId":"GeneralMerchandise","level":"2"},

{"id":"Tea","name":"Tea teas","shortName":"Tea teas","parentId":"100000","level":"1"},
{"id":"Tea","name":"Tea","shortName":"Tea","parentId":"Tea","level":"2"},
{"id":"TeaWare","name":"Tea Ware","shortName":"TeaWare","parentId":"Tea","level":"2"},
{"id":"TeaPackaging","name":"Tea Packaging","shortName":"Tea Packaging","parentId":"Tea","level":"2"},

{"id":"ClothingTextiles","name":"Clothing Textiles","shortName":"Clothing Textiles","parentId":"100000","level":"1"},
{"id":"Clothing","name":"Clothing Shoes and Hats","shortName":"Clothing Shoes and Hats","parentId":"ClothingTextiles","level":"2"},
{"id":"Bedding","name":"Bedding","shortName":"Bedding","parentId":"ClothingTextiles","level":"2"},
{"id":"CurtainCloth","name":"Curtain Cloth","shortName":"Curtain Cloth","parentId":"ClothingTextiles","level":"2"}
];
//借用上展的json转换器
;(function(){
    var data = [],data2 = [];
...
$(function(){
    var mPickerDefaults = {
        ...
        footer: '<div class="mPicker-footer"><a href="javascript:;" class="mPicker-confirm">confirm</a><a href="javascript:;" class="mPicker-cancel">cancel</a></div>',
        confirm: function() {},
        cancel: function() {}
    };
...
$('.goodAddEn').mPicker({
    ...
    idDefault:true,
    splitStr:'-',
    header:'<div class="mPicker-header">Please Choose Goods</div>',
    confirm:function(){
        //更新json
        //this.container.data('mPicker').updateData(level3);
        //console.info($('.select-value').data('value1')+'-'+$('.select-value').data('value2'));
		//alert($('.goodAddEn').data('value1')+'-'+$('.goodAddEn').data('value2'));
		var goods =$("#userFavoriteEn").val();
		var appendValue =$('.goodAddEn').data('value1')+'-'+$('.goodAddEn').data('value2');
		var idx = goods.indexOf(appendValue);
		//alert(1);
		if (idx < 0){
			if(goods){
				goods =goods+'; '+appendValue;	
			} else{
				goods=appendValue;
			}
		}
		$("#userFavoriteEn").val(goods);
    },
    cancel:function(){
        //console.info($('.select-value').data('value1')+'-'+$('.select-value').data('value2'));
    }
