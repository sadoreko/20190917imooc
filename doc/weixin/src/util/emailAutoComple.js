jQuery.AutoComplete = function(selector){
  var elt = $(selector);
  var id = elt.attr('id');
  var strHtml = '<div class="AutoComplete" id="AutoCompleteZh">'+
  ...
  //alert(id);
  if (id=="userEmailEn"){
	 strHtml = '<div class="AutoComplete" id="AutoCompleteEn">'+
	        '    <ul class="AutoComplete_ul">'+
	        '      <li hz="@hotmail.com"></li>'+
	        '      <li hz="@gmail.com"></li>'+
	        '      <li hz="@yahoo.com"></li>'+
	        '      <li hz="@aol.com"></li>'+
	        '      <li hz="@webmail.co.za"></li>'+
	        '      <li hz="@dnet.net.id"></li>'+	        
  ...
  autoComplete = $('#AutoComplete'+prex);    
